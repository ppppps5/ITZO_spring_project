...
<meta charset="UTF-8">
	...
	<%-- <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/image/logo.png"> --%>
<style>
    #registrationform {
        font-size: 20px;
        text-align: center;
...
<div id="page" class="">
    <div id="header" class="clearfix">
        <div class="logo">
          ...
          <h1><a title="ITZO" href="../login/loginForm.jsp"><img src="/ex/resources/image/logo.png" class="logo-link"></a></h1>
    ...
    <div id="registrationform">
        <div id="inputlbl">
            <div>접근이 거부되었습니다.</div><br>
            <div><a href="/ex/">[홈으로 이동]</a></div>
        </div>
    </div>
