...
<link rel="stylesheet" href="/ex/resources/css/notice_content.css">

<script>
var nseq="${noticeDto.nseq}";
var page=1;
$(document).ready(function() {
	...
	$(".delete_btn").on("click", function() {
		fObject.attr("action", "/ex/notice/notice_delete");
		fObject.submit();
	})
	...
	function getPageList(page) {
		$.getJSON("/ex/replies/" + nseq + "/" + page, function(data) {
		...
		<div id="contents">
			...
			<div class="notice_bottom">
				...
				<div class="notice_content">
					...
					<p class="p1">&nbsp;
					<h1>&nbsp;${noticeDto.nTitle}</h1>

					<p class="p2">
					<b>${noticeDto.nWriter}</b>
					<span class="p3"></span>
					<span class="p5">
					<fmt:formatDate	value="${noticeDto.indate}" pattern="yyyy-MM-dd" /></span>
					</p>
					<br>
					<hr>
					<div class="content_detail" style="height: 400px;">
						<br>
						<p class="p3">${noticeDto.nContent}</p>
					</div>
